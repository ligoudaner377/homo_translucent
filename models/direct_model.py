...
class DirectModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(batch_size=64, dataset_mode='translucent',
                            ...
                            n_epochs=10, n_epochs_decay=10, display_ncols=5)  # You can rewrite default values for this model..
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['Normal', 'Rough', 'Depth', 'Scatter', 'Coeffs', 'Reconstruct', 'Direct']
        # specify the images you want to save and display. The program will call base_model.get_current_visuals to save and display these images.
        if self.isTrain:
            self.visual_names = ['normal_predict', 'depth_predict_vis', 'rough_predict', 'direct_predict', 'scene_predict',
                                 'normal_image', 'depth_image_vis', 'rough_image', 'direct_image', 'scene_image']
        else:
            self.visual_names = ['normal_predict', 'depth_predict_vis', 'rough_predict', 'direct_predict', 'scene_predict',
                                 'normal_image', 'depth_image_vis', 'rough_image', 'direct_image', 'scene_image']
        ...
        self.netRenderer = networks.define_G(11, 3, opt.ngf, opt.netRenderer, gpu_ids=self.gpu_ids)
